...
from models.inception.inception.slim import slim
...
def inference(images, num_classes, for_training=False, restore_logits=True,
  ...
  offset_output = tf.slice(endpoints['predictions'], [0, 1], tf.shape(endpoints['predictions']) - [0, 1])

  return offset_output

def inference2(images, num_classes, for_training=False, restore_logits=True,
              scope=None):
  """Build Inception v3 model architecture.
